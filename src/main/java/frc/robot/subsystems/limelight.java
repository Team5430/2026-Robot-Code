...
public class limelight extends SubsystemBase {
  ...
  public Pose2d getBotPose() {
    ...
    return new Pose2d(new Translation2d(pose[0], pose[1]), Rotation2d.fromDegrees(pose[5]));
  }

  // needs to be run on loop in order for camera to use megatag2
  public void setRobotOrientation(DoubleSupplier yawDegrees) {
    data.getEntry("robot_orientation_set")
        .setDoubleArray(new double[] {yawDegrees.getAsDouble(), 0, 0, 0, 0, 0});
  }
